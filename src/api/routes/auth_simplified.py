...
router = APIRouter(prefix="/auth", tags=["auth-simplified"])
logger = get_logger("routes.auth_simplified")
...
async def delete_account(
    ...
    await controller.delete_user_account(user_id, password, confirm_deletion)
